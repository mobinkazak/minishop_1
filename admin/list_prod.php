                              ...
                              <div class="col-md-12">
                                 <form method="get" action="">
                                    <div class="input-group mx-auto">
                                       <input class="text-dark px-2 py-2 col-md-6" value="<?php print $title_fa; ?>" data-toggle="tooltip"
                                       title="عنوان محصول فارسی را وارد نمایید" style="border:1px solid #ddd;" type="text" name="title_fa" placeholder="عنوان فارسی محصول">
                                       <input class="text-dark px-2 col-md-6" value="<?php print $title_en; ?>" data-toggle="tooltip"
                                       title="عنوان محصول انگلیسی را وارد نمایید" style="border:1px solid #ddd;" type="text" name="title_en" placeholder="عنوان انگلیسی محصول">
                                       <input class="text-dark px-2 py-2 col-md-3" value="<?php print $model; ?>" data-toggle="tooltip"
                                       title="مدل محصول را وارد نمایید" style="border:1px solid #ddd;" type="text" name="model" placeholder="مدل محصول">
                                       <input class="text-dark px-2 col-md-3 col-sm-12" value="<?php print $price; ?>" data-toggle="tooltip"
                                       title="قیمت محصول را وارد نمایید" style="border:1px solid #ddd;" type="text" name="price" placeholder="قیمت محصول">
                                       <input class="text-dark px-2 col-md-3 col-sm-12" value="<?php print $code; ?>" data-placement="bottom" data-toggle="tooltip" title="کد محصول را وارد نمایید" style="border:1px solid #ddd;" type="text" name="code" placeholder="کد محصول">
                                       <input class="text-dark px-2 col-md-3 col-sm-12" value="<?php print $discount; ?>" data-placement="bottom" data-toggle="tooltip" title="قیمت تخفیف محصول را وارد نمایید" style="border:1px solid #ddd;" type="text" name="discount" placeholder="قیمت تخفیف محصول">
                                       <div class="input-group-append">
                                          ...
                                          <select style="font-size:14px;border:1px solid #ddd;width:254px;" name="sub_cat_id" id="sub_cat_id">
                                             ...
                                             if ($cat_id>0) {
                                                ...
                                                ?>
                                                <option <?php print $sel2; ?> value="<?php print $row['id'] ?>"><?php print $row['title']; ?></option>
                                                <?php
                                                }
                                             }
                                             ?>
