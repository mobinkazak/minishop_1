                            ...
                            <div class="card">
                                <div class="card-body px-3">
                                        ...
                                        <div class="col-md-12">
                                            <form method="get" action="">
                                                <div class="input-group mx-auto">
                                                    <input class="text-dark px-2 py-2 col-md-6" value="<?php print $title_fa; ?>" data-toggle="tooltip" title="عنوان محصول فارسی را وارد نمایید" style="border:1px solid #ddd;" type="text" name="title_fa" placeholder="عنوان فارسی محصول">
                                                    <input class="text-dark px-2 col-md-6" value="<?php print $title_en; ?>" data-toggle="tooltip" title="عنوان محصول انگلیسی را وارد نمایید" style="border:1px solid #ddd;" type="text" name="title_en" placeholder="عنوان انگلیسی محصول">
                                                    <input class="text-dark px-2 py-2 col-md-3" value="<?php print $model; ?>" data-toggle="tooltip" title="مدل محصول را وارد نمایید" style="border:1px solid #ddd;" type="text" name="model" placeholder="مدل محصول">
                                                    <input class="text-dark px-2 col-md-3 col-sm-12" value="<?php print $price; ?>" data-toggle="tooltip" title="قیمت محصول را وارد نمایید" style="border:1px solid #ddd;" type="text" name="price" placeholder="قیمت محصول">
                                                    <input class="text-dark px-2 col-md-3 col-sm-12" value="<?php print $code; ?>" data-placement="top" data-toggle="tooltip" title="کد محصول را وارد نمایید" style="border:1px solid #ddd;" type="text" name="code" placeholder="کد محصول">
                                                    <input class="text-dark px-2 col-md-3 col-sm-12" value="<?php print $discount; ?>" data-placement="top" data-toggle="tooltip" title="قیمت تخفیف محصول را وارد نمایید" style="border:1px solid #ddd;" type="text" name="discount" placeholder="قیمت تخفیف محصول">
                                                    <div class="input-group-append">
                                                        <select class="py-2" style="font-size:14px;border:1px solid #ddd;width:254px;margin-right: 1px" name="cat_id" id="cat_id">
                                                            <option <?php ($cat_id == -1) ? print 'selected' : print ''; ?> value="-1">دسته ای مورد نظر را انتخاب کنید</option>
                                                            <?php
                                                            $res = $backend->getParentCategoryList();
                                                            while ($parentRow = $backend->getRow($res)) {
                                                                $sel1 = ($parentRow['id'] == $cat_id) ? 'selected' : '';
                                                            ?>
                                                                <option <?php print $sel1; ?> value="<?php print $parentRow['id'] ?>">
                                                                    <?php print $parentRow['title']; ?></option>
                                                            <?php
                                                            }
                                                            ?>
                                                        </select>
                                                        <select style="font-size:14px;border:1px solid #ddd;width:254px;" name="sub_cat_id" id="sub_cat_id">
                                                            <option <?php ($sub_cat_id == -1) ? print 'selected' : print ''; ?> value="-1">زیر دسته ای مورد نظر را انتخاب کنید</option>
                                                            <?php
                                                            if ($cat_id > 0) {
                                                        ...
                                                        <select name="status" id="status" style="font-size:14px;border:1px solid #ddd;width:130px;">
                                                            <option value="-1" <?php ($status == -1) ? print 'selected' : print ''; ?>>وضعیت
                                                                محصول</option>
                                                        ...
                                                        <select name="special" id="is_special" style="font-size:14px;border:1px solid #ddd;width:129px;">
                                                            <option value="-1" <?php ($is_special == -1) ? print 'selected' : print ''; ?>>
                                                                محصولات ویژه</option>
                                                            <option value="1" <?php ($is_special == 1) ? print 'selected' : print ''; ?>>بله
                                                            </option>
                                                            <option value="0" <?php ($is_special == 0) ? print 'selected' : print ''; ?>>خیر
                                                            </option>
                                                        </select>
                                    ...
                                    <form action="" method="post">
                                        <button class="btn-sm btn-danger border-0" value="1" name="btn_del_gp" type="submit">حذف گروهی</button>
                                        <table class="table table-bordered table-responsive-sm table-hover table-responsive-md table-responsive-xl overflow-auto">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><input type="checkbox" name="checkbox_rows[]" value="<?php print $row['id']; ?>" class="check-group"></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($row['is_special'] == 1) {
                                                            ?>
                                                                <button onclick="redirect('<?php print "$url&p=$backend->page&sp_id=$row[id]&val=0"; ?>')" data-toggle="tooltip" title="غیر ویژه کردن محصول" type="button" class="btn-sm btn-danger border-0">
                                                                    <i class="mdi mdi-star-off"></i>
                                                                </button>
                                                            <?php
                                                            } else {
                                                            ?>
                                                                <button onclick="redirect('<?php print "$url&p=$backend->page&sp_id=$row[id]&val=1"; ?>')" data-toggle="tooltip" title="ویژه سازی محصول" type="button" class="btn-sm btn-info border-0">
                                                            ...
                                                            if ($row['status'] == 1) {
                                                            ?>
                                                                <button onclick="change_status(<?php print $row['id'] ?>,0)" data-toggle="tooltip" title="غیر فعال کردن محصول" type="button" class="btn-sm btn-danger border-0">
                                                                    <i class="mdi mdi-eye-off"></i>
                                                                </button>
                                                            <?php
                                                            } else {
                                                            ?>
                                                                <button onclick="change_status(<?php print $row['id'] ?>,1)" data-toggle="tooltip" title="فعال کردن محصول" type="button" class="btn-sm btn-success border-0">
                                                            ...
                                                            <a data-toggle="tooltip" title="ویرایش" href="<?php print ADMIN_URL ?>edit_prod.php<?php print $url; ?>&index=<?php print $row['id']; ?>&p=<?php print $backend->page; ?>" class="btn-sm btn-warning"><i class="mdi mdi-pencil"></i></a>

                                                            <button data-id="<?php print $row['id']; ?>" data-idlist="<?php print $idList; ?>" data-title="<?php print $row['title_fa']; ?>" data-toggle="modal" data-target="#deleteModal" type="button" rel="tooltip" title="حذف" class="btn-sm btn-danger border-0"><i class="mdi mdi-delete-empty"></i></button>
                                                        </td>
                                                    </tr>
                                                <?php
